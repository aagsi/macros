...
./prtdirc -s 3 -i "${DIRd}/beam_s332_20C.root" -u "${DIRl}/lut_opt_332_2018_cs_avr.root" -o "${DIRr}/sepPDF_20_sph_data.root"  -e $nevents -v 2 -tr 5.0 -chcut 5.0 -recoangle $recoAngle20_proton -t1 0 -t2 0 -gpdf 2
#: <<'END'
