...
////////////////////
// fitting functions
Double_t* FitHisto(TH1F *p_cherenkov_sim, TH1F *p_cherenkov_sim_correction, TH1F * p_cherenkov_mc_same_path, TH1F *p_cherenkov_data_sub, TH1F * p_diff_time_data, TH1F * p_diff_time_mctruth, TH1F * p_diff_time_sim, Int_t &i, TH1F *p_cherenkov_data_copy,TH1F *p_cherenkov_data, TH1F *p_cherenkov_data_correction);
// file existance
...
void pi_plots() {
    ...
    for (int i=20; i<=150; i+=10) {
        ...
        //if (path=="/SAT/nyx/panda/aali/prtdrc_2017/final_2017/workspace/testbeam/recon/data/332/opt/theta_50_timecut_4.9_chcut_0.001_3lsph_proton_data_spr.root") continue;
        //if (path=="/SAT/nyx/panda/aali/prtdrc_2017/final_2017/workspace/testbeam/recon/data/332/opt/theta_60_timecut_4.7_chcut_0.001_3lsph_proton_data_spr.root") continue;
        //if (path=="/SAT/nyx/panda/aali/prtdrc_2017/final_2017/workspace/testbeam/recon/data/332/opt/theta_60_timecut_5.9_chcut_0.037_3lsph_proton_data_spr.root") continue;
        //if (path=="/SAT/nyx/panda/aali/prtdrc_2017/final_2017/workspace/testbeam/recon/data/332/opt/theta_60_timecut_5.9_chcut_0.041_3lsph_proton_data_spr.root") continue;
        //if (path=="/SAT/nyx/panda/aali/prtdrc_2017/final_2017/workspace/testbeam/recon/data/332/opt/theta_120_timecut_5.9_chcut_0.037_3lsph_proton_data_spr.root") continue;
        cout<<"path_sim= " <<path_sim<<endl;
        cout<<"path_data= " <<path_data<<endl;
        //std::cout<<"############"<< " no problem 1 " <<std::endl;
        //ffile_sim[i][j][k]  = new TFile(cherenkov_data_path,"read");
        ...
        if(false) {
            if (false) { // done 1
                ...
                legend_ch_match->SetHeader("Ambiguity distribution (pi data)","C");
        ...
        if(true) {
            ...
            // fitting histograms
            Double_t  *out_array = FitHisto(p_cherenkov_sim,p_cherenkov_sim_correction, p_cherenkov_mc_same_path, p_cherenkov_data_sub, p_diff_time_data, p_diff_time_mctruth, p_diff_time_sim, i, p_cherenkov_data_copy,p_cherenkov_data, p_cherenkov_data_correction);
            ...
            y_deviation_cangle_data_sub[counter]= fAnglePi - out_array[20];
            y_spr_data_cuts[counter]=fAnglePi-out_array[22];// warning switch between p and pi
            y_spr_sim_cuts[counter]=fAnglePi-out_array[12];// warning
            y_spr_data_sub_cuts[counter]=fAnglePi- out_array[11]; // warning
            y_spr_sim_true_cuts[counter]= fAnglePi- out_array[10];// warning
            y_cangle_data_correction[counter]=out_array[25];
            y_spr_data_correction[counter]=out_array[26];
            y_cangle_data_org[counter]=out_array[27];
            y_spr_data_org[counter]=out_array[28];
            y_cangle_sim_correction[counter]=out_array[29];
            y_spr_sim_correction[counter]=out_array[30];
            ...
            if (false) { // done
                ...
                legend_nph_sim->SetHeader("photon yield (pi sim)","C");
            ...
            if (false) { // done
                ...
                legend_nph_data->SetHeader("photon yield (pi data)","C");
                ...
                //legend_nph_data->AddEntry(dac_hits_sys_cus_data,"DAC hits with auxiliary detectors cuts and PID cut(pi data)","f");
            ...
            if(false) { // done
                ...
                legend_signal->SetHeader("cherenkov angle (pi sim)","C");
            ...
            if(false) { // done
                ...
                legend_bg_sub->SetHeader("ambiguity distribution (pi)","C");
            ...
            if (false) { // done
                ...
                legend_diff_bg_sub->SetHeader("time difference distribution (pi)","C");
            ...
            if (false) { // done
                ...
                legend_photon_time_calc->SetHeader("calculated time match (pi)", "C");
            ...
            if (false) { // done
                ...
                legend_photon_time->SetHeader("measured time match (pi)","C");
    ...
    if(true) {
        ...
        TGraph *graph_spr_sim_correction = new TGraph(n,x,y_spr_sim_correction);
        ...
        TGraph *graph_cangle_sim_correction = new TGraph(n,x,y_cangle_sim_correction);
        ...
        graph_yield_DIRC_wt_cuts_data->SetLineColor(kPink);
        ...
        if(true) {
            ...
            leg_spr1->AddEntry(graph_spr_data_org, "graph_spr_data_org ", "lp");
            leg_spr1->AddEntry(graph_spr_sim, "graph_spr_sim", "lp");
            ...
            leg_spr2->AddEntry(graph_spr_data_sub, "graph_spr_data_sub ", "lp");
            leg_spr2->AddEntry(graph_spr_sim_true, "graph_spr_sim_true", "lp");
            ...
            leg_spr3->AddEntry(graph_spr_data_correction, "graph_spr_data_correction ", "lp");
            leg_spr3->AddEntry(graph_spr_sim_correction, "graph_spr_sim_correction", "lp");
            
            TCanvas *c_spr = new TCanvas("c_spr","c_spr",200,10,700,500);
            c_spr->Divide(1,3);
            c_spr->cd(1);
        ...
        if(false) {
            ...
            leg_yield1->SetHeader("photon yield (#pi)","C");
            ...
            leg_yield2->SetHeader("photon yield (#pi)","C");
            ...
            leg_yield3->SetHeader("photon yield (#pi)","C");
...
Double_t* FitHisto(TH1F *p_cherenkov_sim,TH1F *p_cherenkov_sim_correction,  TH1F * p_cherenkov_mc_same_path, TH1F * p_cherenkov_data_sub, TH1F * p_diff_time_data, TH1F * p_diff_time_mctruth, TH1F * p_diff_time_sim, Int_t &i, TH1F *p_cherenkov_data_copy, TH1F *p_cherenkov_data, TH1F * p_cherenkov_data_correction) {
    ...
    if(p_cherenkov_sim->GetEntries()>20) {
        ...
        fFit_sim_correction->SetParLimits(2,0.005,0.016); // changed 0.014
        ...
        return_array[29]=cangle_sim_correction;
        return_array[30]=spr_sim_correction;
